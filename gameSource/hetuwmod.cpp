...
void HetuwMod::drawMap() {
	...
	char strZoomKeys[64];
	sprintf( strZoomKeys, translate( "strZoomKeysTip" ), toupper(charKey_MapZoomIn), toupper(charKey_MapZoomOut), toupper(charKey_ShowMap)); 
...
void HetuwMod::drawHelp() {
	...
	drawPos.y -= lineHeight;
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_1" ), drawPos, guiScale );
	drawPos.y -= lineHeight;
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_2" ), drawPos, guiScale );
	drawPos.y -= lineHeight;

	drawPos.y -= lineHeight;
	drawPos.y -= lineHeight;
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_3" ) );
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	...
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_4" ), drawPos, guiScale );
	drawPos.y -= lineHeight;

	setHelpColorSpecial();
	sprintf(str, translate( "helpTip_5" ), toupper(charKey_ShowHelp));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (cameraIsFixed) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_6" ), toupper(charKey_FixCamera));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (iDrawNames > 0) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_7" ), toupper(charKey_ShowNames));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (bDrawCords) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_8" ), toupper(charKey_ShowCords));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (iDrawPlayersInRangePanel > 0) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_9" ), toupper(charKey_ShowPlayersInRange));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	...
	if (bDrawHomeCords) setHelpColorSpecial();
		...
		sprintf(str, translate( "helpTip_10" ), toupper(charKey_ShowHomeCords));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (bDrawHostileTiles) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_11" ), toupper(charKey_ShowHostileTiles));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (bxRay) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_12" ), toupper(charKey_xRay));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (bDrawYum) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_13" ), toupper(charKey_FindYum));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (bDrawGrid) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_14" ), toupper(charKey_ShowGrid));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	setHelpColorNormal();

	sprintf(str, translate( "helpTip_15" ), toupper(charKey_Pocket));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	sprintf(str, translate( "helpTip_16" ), toupper(charKey_Pocket));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	...
	sprintf(str, translate( "helpTip_17" ), toupper(charKey_Backpack));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_18" ), toupper(charKey_Backpack));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_19" ), toupper(charKey_TakeOffBackpack));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_20" ), toupper(charKey_Eat));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_21" ), toupper(charKey_Baby));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_22" ), toupper(charKey_Up), toupper(charKey_Left), toupper(charKey_Down), toupper(charKey_Right));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_23" ), toupper(charKey_Up), toupper(charKey_Left), toupper(charKey_Down), toupper(charKey_Right));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_24" ), toupper(charKey_Up), toupper(charKey_Left), toupper(charKey_Down), toupper(charKey_Right));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	if (charKey_TileStandingOn == ' ') sprintf(str, translate( "helpTip_25if" ) );
	else sprintf(str, translate( "helpTip_25" ), toupper(charKey_TileStandingOn));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	if (charKey_TileStandingOn == ' ') sprintf(str, translate( "helpTip_26if" ) );
	else sprintf(str, translate( "helpTip_26" ), toupper(charKey_TileStandingOn));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_m1" ), drawPos, guiScale );
	drawPos.y -= lineHeight;
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_m2" ), drawPos, guiScale );
	drawPos.y -= lineHeight;
	livingLifePage->hetuwDrawScaledHandwritingFont( translate( "helpTip_m3" ), drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_27" ), toupper(charKey_CreateHome));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_28" ), toupper(charKey_CreateHome));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	sprintf(str, translate( "helpTip_29" ), toupper(charKey_ShowCords));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;

	if (searchWordList.size() > 0) setHelpColorSpecial();
	else setHelpColorNormal();
	sprintf(str, translate( "helpTip_30" ), toupper(charKey_Search));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	setHelpColorNormal();
	sprintf(str, translate( "helpTip_31" ), toupper(charKey_Search));
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	...
	sprintf(str, translate( "helpTip_32" ) );
	livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	drawPos.y -= lineHeight;
	...
	if (connectedToMainServer && arcRunningSince > 0) {
		...
		drawPos.y += viewHeight/2 - 30*guiScale;
		sprintf(str, translate( "helpTip_33" ), getArcTimeStr().c_str());
		livingLifePage->hetuwDrawScaledHandwritingFont( str, drawPos, guiScale );
	}
}
